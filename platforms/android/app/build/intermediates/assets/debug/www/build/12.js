...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vendor__ = __webpack_require__(522);
...
var VendorPageModule = /** @class */ (function () {
    ...
    VendorPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__vendor__["a" /* VendorPage */]),
            ],
        })
    ], VendorPageModule);
...
var VendorPage = /** @class */ (function () {
    ...
    VendorPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-vendor',template:/*ion-inline-start:"E:\workspace\bherampur project\brahmapur\src\pages\vendor\vendor.html"*/'<ion-header >\n\n    <ion-toolbar color="header">\n\n\n\n  <ion-navbar>\n\n    <ion-title>Vendor</ion-title>\n\n</ion-navbar>\n\n  </ion-toolbar>\n\n\n\n</ion-header>\n\n\n\n\n\n\n\n  <ion-content>\n\n    <ion-list>\n\n      <ion-item *ngFor="let item of vendorList" (click)="goToProfile(item)">\n\n        <ion-thumbnail item-left class="item-ribbon">\n\n          <span class="ribbon {{ item.class }}">\n\n            <span>Verifed</span>\n\n          </span>\n\n          <img src="https://cdn2.iconfinder.com/data/icons/office-icons/256/Office_Man_Office_Worker-128.png">\n\n        </ion-thumbnail>\n\n        <div>\n\n            <p >{{ item.firstname }} {{item.lastname}}</p>\n\n            <p >{{ item.shopname }} </p>\n\n            <p >{{ item.city }}</p>\n\n            <p >{{ item.address }}</p>\n\n            <div class="ico-all">\n\n              <ion-icon name="mail" color="primary" item-start></ion-icon>\n\n              <ion-icon name="call" color="danger" item-start></ion-icon>\n\n              <ion-icon name="logo-whatsapp" color="secondary" item-start></ion-icon>\n\n            </div>\n\n          </div>\n\n      </ion-item>\n\n\n\n\n\n    </ion-list>\n\n\n\n  </ion-content>\n\n'/*ion-inline-end:"E:\workspace\bherampur project\brahmapur\src\pages\vendor\vendor.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_services_services__["a" /* ServicesProvider */]])
    ], VendorPage);
    return VendorPage;
}());
