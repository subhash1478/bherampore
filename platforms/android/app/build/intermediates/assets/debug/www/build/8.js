...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_geolocation__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_google_maps__ = __webpack_require__(468);
...
var ProfilePageModule = /** @class */ (function () {
    ...
    ProfilePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__ionic_native_google_maps__["a" /* GoogleMaps */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_geolocation__["a" /* Geolocation */]],
            imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_observable_fromEvent__ = __webpack_require__(252);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_google_maps__ = __webpack_require__(468);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProfilePage = /** @class */ (function () {
    function ProfilePage(navCtrl, navParams, geolocation) {
    ...
    ProfilePage.prototype.ionViewDidLoad = function () {
        ...
        var result = this.navParams.data.data;
        this.user = {
        ...
        this.map.one(__WEBPACK_IMPORTED_MODULE_3__ionic_native_google_maps__["b" /* GoogleMapsEvent */].MAP_READY)
            ...
            _this.map.addMarker({
                ...
                marker.on(__WEBPACK_IMPORTED_MODULE_3__ionic_native_google_maps__["b" /* GoogleMapsEvent */].MARKER_CLICK)
                    .subscribe(function () {
                    alert(_this.user.shopname);
                });
            });
        });
    };
    ProfilePage.prototype.goToReview = function () {
        this.navCtrl.push("ReviewPage", { id: this.user.userid });
    };
    ProfilePage.prototype.openChat = function (item) {
        this.navCtrl.push('ChatPage', item);
    };
    ProfilePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-profile',template:/*ion-inline-start:"E:\workspace\bherampur project\brahmapur\src\pages\profile\profile.html"*/'<ion-header>\n\n  <ion-navbar color="header">\n\n    <ion-title>Profile</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content parallax-header no-bounce class="bg-modal">\n\n  <div class="header-image" *ngIf="user.profileImage!=null" [ngStyle]="{\'background\' : \'url(\' + user.profileImage + \')center no-repeat\'}"></div>\n\n  <div class="header-image" *ngIf="user.profileImage==null" style="background: url(\'assets/imgs/avatar.png\')center no-repeat;"></div>\n\n  <div class="main-content" text-wrap text-center>\n\n\n\n\n\n\n\n\n\n    <h2>{{user.name}}</h2>\n\n\n\n    <button ion-button small round outline (click)="goToReview()">Review</button>\n\n    <button ion-button small round outline (click)="openChat(user)">      <ion-icon name="chatbubbles"></ion-icon> Chat\n\n        </button>\n\n\n\n    <p>{{user.occupation}} &bull; {{user.location}}</p>\n\n    <p class="profile-description">{{user.description}}</p>\n\n    <hr>\n\n    <ion-list no-lines>\n\n      <ion-item>\n\n        <ion-icon name="mail" color="primary" item-start></ion-icon>\n\n        <p>Email</p>\n\n        {{user.email}}\n\n        <a button ion-button href="mailto:{{user.email}}" color="primary" item-end medium>Open App</a>\n\n      </ion-item>\n\n      <ion-item>\n\n        <ion-icon item-start name="call" color="danger"></ion-icon>\n\n        <p>Mobile</p>\n\n        {{user.phone}}\n\n        <a button ion-button href="tel:{{user.phone}}" color="danger" item-end medium>Poke me</a>\n\n      </ion-item>\n\n      <ion-item>\n\n        <ion-icon item-start name="logo-whatsapp" color="secondary"></ion-icon>\n\n        <p>Whatsapp</p>\n\n        {{user.whatsapp}}\n\n        <a button ion-button color="secondary" item-end medium href="whatsapp://send?text=Hi from ionic&phone=+{{user.phone}}&abid=+{{user.phone}}">Open App</a>\n\n      </ion-item>\n\n      <ion-item>\n\n        <ion-icon item-start name="pin" color="twitter"></ion-icon>\n\n        <p>{{user.address}}</p>\n\n      </ion-item>\n\n    </ion-list>\n\n    <h2>Get in touch</h2>\n\n    <hr>\n\n    <div id="map_canvas" style="width:100%;height:200px;"></div>\n\n\n\n  </div>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"E:\workspace\bherampur project\brahmapur\src\pages\profile\profile.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_geolocation__["a" /* Geolocation */]])
    ], ProfilePage);
    return ProfilePage;
}());
