...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__notification__ = __webpack_require__(394);
...
var NotificationPage = /** @class */ (function () {
    ...
    NotificationPage.prototype.ionViewDidLoad = function () {
        ...
        this._services.getNotification(obj).subscribe(function (response) {
            ...
            console.log('====================================');
            _this.notificationList = response.response.data;
        }, function (error) {
        });
    };
