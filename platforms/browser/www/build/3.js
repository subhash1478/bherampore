...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__post__ = __webpack_require__(397);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ngx_order_pipe__ = __webpack_require__(398);
...
var PostPageModule = /** @class */ (function () {
    ...
    PostPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [__WEBPACK_IMPORTED_MODULE_3_ngx_rating__["RatingModule"], __WEBPACK_IMPORTED_MODULE_4_ngx_order_pipe__["a" /* OrderModule */],
    ...
    PostPage.prototype.ionViewDidLoad = function () {
        ...
        this._services.search(obj).subscribe(function (Response) {
            ...
            for (var index = 0; index < result.length; index++) {
                ...
                if (resultdata.images.length < 1 || !resultdata.images) {
                    element['images'] = _this.image;
                }
                else {
