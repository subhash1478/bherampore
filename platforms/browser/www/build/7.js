...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__postdetails__ = __webpack_require__(399);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_launch_navigator__ = __webpack_require__(373);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_launch_navigator__ = __webpack_require__(373);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    PostdetailsPage.prototype.ngOnInit = function () {
        ...
        this._services.getPostDetails(this.post).subscribe(function (Response) {
            ...
            for (var i = 0; i < image.length; i++) {
                var res = {};
                res['image'] = __WEBPACK_IMPORTED_MODULE_3__config__["a" /* Config */].SOCKET_ENDPOINT + 'image/postimage/' + image[i].image;
                imageval.push(res);
            }
