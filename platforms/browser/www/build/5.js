...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__review__ = __webpack_require__(405);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_rating__ = __webpack_require__(329);
...
var ReviewPage = /** @class */ (function () {
    function ReviewPage(navCtrl, navParams, modalCtrl, _services) {
    ...
    ReviewPage.prototype.ionViewDidLoad = function () {
        ...
        this._services.getreview(obj).subscribe(function (Response) {
            console.log(Response);
            _this.reviewlist = Response.data;
        });
    };
    ReviewPage.prototype.goToReviewpage = function () {
        var _this = this;
        var review = this.modalCtrl.create("AddreviewPage", { id: this.param.id, type: this.param.type });
        review.present();
        review.onDidDismiss(function (data) {
            console.log(data);
    ...
    ReviewPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-review',template:/*ion-inline-start:"/opt/workspace/project/shop/src/pages/review/review.html"*/'<ion-header>\n\n  <ion-toolbar color="header">\n\n    <ion-navbar>\n\n      <ion-title>\n\n        Review\n\n      </ion-title>\n\n    </ion-navbar>\n\n    <ion-buttons end>\n\n      <button (click)="goToReviewpage()" ion-button icon-only>\n\n          <ion-icon ios="ios-add" md="md-add"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-toolbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <ion-list>\n\n\n\n    <ion-item *ngFor="let item of reviewlist async" class="animated fadeIn">\n\n      <ion-avatar item-left>\n\n        <img src="http://139.59.12.86:3001/api/img/?format=jpg&width=200&height=200&image=public/image/user/{{item.userid.profile_image}}">\n\n      </ion-avatar>\n\n    <h2>{{item.userid.firstname}} {{item.userid.lastname}}</h2>\n\n    <p>{{item.comment}}</p>\n\n    <p>rating \n\n      <rating         [readonly]="true"\n\n      [(ngModel)]="item.rating" [max]="5" iconClass="star-icon" fullIcon="★" emptyIcon="☆" [titles]="[\'one\', \'two\', \'three\', \'four\', \'five\']">\n\n      </rating></p>\n\n\n\n    </ion-item>\n\n  </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"/opt/workspace/project/shop/src/pages/review/review.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* ModalController */], __WEBPACK_IMPORTED_MODULE_2__providers_services_services__["a" /* ServicesProvider */]])
    ], ReviewPage);
    return ReviewPage;
}());
